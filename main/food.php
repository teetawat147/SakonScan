...
<body>
    <fieldset id="food" style="display:block;">
    ...
    <form class="form" action="userRegisterInsert.php" method="POST">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input name="foodName" id="foodName" class="form-control" min="3" required type="text" data-error-msg="กรุณากรอกเลขบัตรประจำตัวประชาชน">
            </div>
        
            <div class="form-group col-md-6">
                <label for="tradeName">เลข อย.</label>
        ...
        <div class="form-row">    
            <div class="form-group col-md-6">
                <label for="ingredient">วันหมดอายุ</label>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="registrationNumber">ส่วนประกอบ</label>
            ...
            <div class="form-group col-md-6">
                <label for="registrationNumber">รับมาจาก/ที่มา</label>
                <input name="registrationNumber" id="registrationNumber" class="form-control" min="3" required type="text" data-error-msg="กรุณากรอก Password">
            </div>
        </div><br>
